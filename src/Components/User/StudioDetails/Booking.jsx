...
function Booking({ studio,open,setOpen,successMessage,setSuccessMessage }) {
    ...
    return (
        <>
                                ...
                                <div>
                                    <label className="flex items-center">
                                        <input
                                            type="checkbox"
                                            className="w-3 h-3"
                                            checked={selectedCategories.includes(category.categories._id)}
                                            onChange={() => handleCheckboxChange(category.categories._id, category.price)}
                                        />
                    ...
                    <div className='flex flex-col'>
                        ...
                        <div className='flex flex-col mt-3 gap-3'>
                            ...
                            <div className='flex gap-2 '>
                                ...
                                <input type='number' placeholder='Phone' name='phone' onChange={handleChange} className='border py-2 px-2 w-[18rem] rounded-[5px] outline-none' />
                            </div>
                            <div className='flex flex-col gap-1'>
                                {/* <label className='text-[15px] text-gray-500'>Event date</label> */}
                                <input type='date' placeholder='Event date' name='eventDate' onChange={handleChange} className='border py-2 w-[285px] text-gray-500 rounded-[5px] outline-none px-2' />
                            </div>
                        </div>
                        ...
                        <button className='border border-red-500 py-2 mt-3 rounded-[5px] bg-red-600 text-white font-bold hover:bg-red-500' onClick={handleSubmit}>Send</button>
                    </div>
                </div> :
                <div>
                </div>
            ...
            {
                successMessage ?
                    <div className='border absolute top-[15rem]  left-[27rem] rounded-xl bg-white w-[38rem] h-[14rem]' style={{ boxShadow: 'rgba(0, 0, 0, 0.35) 0px 5px 15px' }} >
                        <div className='flex flex-col '>
                            <div className='flex flex-col py-6  px-6'>

                                <div className='flex gap-5 '>
                                    <img className='w-[4rem]' src='https://media0.giphy.com/media/NikzzPlFuvoCzWS7IX/giphy.gif?cid=6c09b952xnht9vja8kqrzj75f3z6o53tp331ei3j8i08aidx&ep=v1_stickers_related&rid=giphy.gif&ct=s' alt=''></img>
                                    <p className='my-4 font-bold text-[20px]'>Request sent Successfully</p>
                                </div>
                                <div >
                                    <p className='mx-20'>Your enquiry to {studio.companyName} was sent successfully.we will let you know once we varified.</p>
                                </div>
