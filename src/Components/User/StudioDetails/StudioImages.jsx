   ...
   return (
      <>
         <div className={`flex ${open || successMessage ? 'inset-0 opacity-80' : 'opacity-1'}`}>
            <div className='w-[60rem] flex h-[27rem] ms-24 my-3'>
               <div className='w-[27rem] h-[27rem]'>
                  <img className='object-cover w-[27rem] h-[27rem] rounded-tl-xl rounded-bl-xl' src={studio.images.images[1]?.photos[0]} alt='' />
