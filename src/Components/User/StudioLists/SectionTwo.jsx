    ...
    <div>
      ...
      <div className="mx-14 px-2 mt-" style={{ fontFamily: "Noto Serif" }}>
        ...
        {/* <div className="flex justify-evenly gap-12">
          <div className="border border-green-500 w-[7rem] h-[7rem] mt- rounded-full">
            <div className="flex flex-col gap-2 justify-center">

            <img
              className="w-[7rem] h-[7rem]  rounded-full object-cover"
              src="https://cdn1.weddingwire.in/assets/img/home/bg_home3.jpg"
              alt=""
            />
            <p>Bridal Photography</p>
            </div>
          </div>
          <div className="border border-green-500 w-[7rem] h-[7rem] mt-10 rounded-full">
           <div className="flex flex-col gap-2 justify-center">
        ...
        {/* <div className="flex justify-end mb-10 me-3">
          <div className="bg-gray-300 w-[28rem] h-[4rem] flex"></div>
        </div> */}
        </div>
          ...
          {studioDetails.map((studio) => (
            ...
            >
              <div className="cursor-pointer">
                <img
                  className="h-[15rem] w-[40rem] object-cover"
                  src={studio?.images?.images[0]?.photos[0]}
                  alt=""
                />
              </div>
              <div className="p-6">
                ...
                <div></div>
                <p className="mb-4 text-base text-black">{studio.district}</p>
                <p className="mb-4 text-base text-black">Hello</p>
                <p className="mb-4 text-base text-black">Hello</p>
                <button className="py-2 px-2 w-full border border-red-500 text-red-500 rounded-[7px] font-bold hover:bg-red-500 hover:text-white">
                  Request Pricing
                </button>
              </div>
            </div>
