...
function SectionOne() {
  return (
    <div className='w-full  flex ' style={{fontFamily:'Noto Serif'}}>
       {/* <div className='flex flex-col mx-24 mt-5 '>
        <p className='text-[25px]'>Photographers in India (69619):</p>
        <p className='text-[15px] text-gray-500'>The biggest day of your life deserves to be captured by the most talented ones. Find the list of wedding photographers in all Indian cities. Both premium and budget photographers are listed in all categories including traditional, candid, drone & pre-wedding photography. Browse through their photos and reviews and contact them directly or simply request for a callback from us. </p>
      </div>  */}
   <div className='justify-center px-20 w-[50%]    h-[15rem] flex flex-col gap-2'>
