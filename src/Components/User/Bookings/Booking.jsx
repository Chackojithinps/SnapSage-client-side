            ...
            {bookingList && bookingList.map((bookings) => (
                <section className="container mx-auto mt-14 md:mt-0 p-10 md:py-4 md:px-20 antialiased" style={{ fontFamily: 'Noto Serif' }}>
                    <article
                        ...
                        <img className="w-full max-h-[300px] object-cover md:w-[23rem]" src="https://i.ibb.co/Kr4b0zJ/152013403-10158311889099633-8423107287930246533-o.jpg" alt="" />
                        <div className="">
                            ...
                            <div className="bg-blue-50 px-8 py-2 md:w-[63rem]">
