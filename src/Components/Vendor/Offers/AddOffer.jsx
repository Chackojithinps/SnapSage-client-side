...
function AddOffer() {
  ...
  return (
    <div className='' style={{ fontFamily: 'Noto Serif' }}>
      <div class=" w-[40rem] absolute top-28 left-[30rem] rounded-lg shadow dark:bg-white" style={{ boxShadow: 'rgba(0, 0, 0, 0.35) 0px 5px 15px' }}>
                        ...
                        <form class="space-y-6 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8" action="">   
                            ...
                            <div>
                                <label for="fname" class="text-sm font-medium text-gray-900 block mb-2 ">Offer Name</label>
                                <input type="text" name="offerName" id="" onChange={handleInputChange}  class=" border border-gray-50 outline-none  text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-500 dark:placeholder-gray-400 text-black"  required=""/>
                            </div>
                            <div>
                                <label for="lname" class="text-sm font-medium text-gray-900 block mb-2 ">Offer Percentage</label>
                                <input type="number" name="percentage" id="lname" onChange={handleInputChange}  class=" border outline-none  border-gray-300 text-black sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-500 dark:placeholder-gray-400 dark:text-black font-bold"  required=""/>
                            </div>
                            <div>
                                <label for="lname" class="text-sm font-medium text-gray-900 block mb-2 ">Offer Description</label>
                                <textarea type="textarea" name="description" id="lname" onChange={handleInputChange}  class="bg-gray-50 border outline-none  border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-500 dark:placeholder-gray-400 text-black" required=""/>
                            </div>
                            
                            <button type="submit" onClick={handleAddOffer}  class="w-full text-white bg-blue-700 hover:bg-blue-800 outline- focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Edit Your Profile</button>
