    ...
    <>
      <div className='flex my-5' style={{ fontFamily: 'Noto Serif' }} >
        ...
        <div className='  flex flex-col gap-5 -red-500  h-[40rem] ms-28 w-[40rem]'>
          ...
          {!VendorRegister?<button className='py-4 rounded bg-[#2e1065] text-white mt-5 mx-auto px-4  -red-500 w-[17rem]' onClick={()=>navigate('/vendor/register')}>Let's partener together</button>:<div><p className='text-black flex items-center justify-center font-bold text-xl mt-6 bg-gray-200 h-[3rem]'>{VendorRegister}</p></div>}
        </div>
